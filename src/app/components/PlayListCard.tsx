...
function CreatePlayListCard() {
  ...
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.95 }}
      className={`shadow-md focus:outline-none bg-gradient-to-t from-${theme}-primary-1 via-${theme}-primary-2 to-${theme}-primary-3 w-44 h-52 rounded-md hover:to-${theme}-secondary-2 hover:from-${theme}-secondary-2 hover:via-${theme}-secondary-2`}
    >
    ...
    >
      <Link to={`/playlists/${playlist.name}`}>
        <motion.div
          whileHover={{ scale: 1.05 }}
          whileTap={{ scale: 0.95 }}
          className={`relative shadow-md focus:outline-none bg-gradient-to-t from-${theme}-primary-1 via-${theme}-primary-2 to-${theme}-primary-3 w-44 h-52 rounded-md hover:to-${theme}-secondary-2 hover:from-${theme}-secondary-2 hover:via-${theme}-secondary-2`}
        >
